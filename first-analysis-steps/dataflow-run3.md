...
For detailed information and implementation examples of ```FunTuple``` and offline data processing in Run 3 see the [DaVinciTutorials](https://gitlab.cern.ch/lhcb/DaVinci/-/tree/master/DaVinciTutorials/python/DaVinciTutorials) and [DaVinci documentation](https://lhcb-davinci.docs.cern.ch/).
